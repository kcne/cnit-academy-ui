...
import { ChevronDown, LogOut, Settings, UserCircle, User as UserIcon } from "lucide-react"
  ...
  return (
    <DropdownMenu open={open} onOpenChange={setOpen}>
      ...
      <DropdownMenuContent align="end" className="w-56">
        ...
        <DropdownMenuSeparator />
        <DropdownMenuItem className="text-red-500 focus:text-red-500 cursor-pointer" onClick={onSignOut}>
